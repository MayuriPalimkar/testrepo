...
public class khan_academy1 {
	WebDriver driver;
	   ...
	   //  WebElement element = driver.findElement(By.xpath("class=\"_1vn7gh5u\""));
	     
	    /* JavascriptExecutor Js = (JavascriptExecutor) driver;
	     Js.executeScript("window.scrollBy(0,1000)");*/
	    	// WebElement page = driver.findElement(By.xpath("//section[@class=\"_4u30mx2\"]"));
	    	 driver.switchTo().frame("class=\"_4u30mx2\"");
